...
def build_hotel_planta_base() -> PlantaBaixa:
    ...
    circulação, administração, áreas de serviço e pátio. Ela não corresponde ao
    Hotel Aurora canônico e não deve ser integrada automaticamente a nenhum caso.
    """
    areas = (
        ...
        AreaPlanta("sala_eventos", "Sala de Eventos", 80, 330, 220, 150, "publico", "A-04"),
        AreaPlanta("administracao", "Administração", 300, 330, 160, 150, "administrativo", "A-05"),
        AreaPlanta("elevadores", "Elevadores", 460, 330, 120, 150, "circulacao", "A-06"),
        AreaPlanta("servico", "Serviço", 580, 330, 160, 150, "servico", "A-07"),
        AreaPlanta("deposito", "Depósito", 740, 330, 120, 150, "apoio", "A-08"),
    )
    areas_externas = (
    ...
    portas = (
        ...
        PortaPlanta("P-04", ("sala_eventos", "corredor_servico"), "H", 160, 330, 44),
        PortaPlanta("P-05", ("administracao", "corredor_servico"), "H", 356, 330, 34, True),
        PortaPlanta("P-06", ("elevadores", "corredor_servico"), "H", 502, 330, 38),
        PortaPlanta("P-07", ("servico", "corredor_servico"), "H", 636, 330, 40, True),
        PortaPlanta("P-08", ("deposito", "corredor_servico"), "H", 786, 330, 34, True),
        PortaPlanta("P-09", ("servico", EXTERIOR), "H", 626, 480, 52, True),
        PortaPlanta("P-10", ("lobby", "recepcao"), "V", 340, 146, 34),
    )
    janelas = (
        JanelaPlanta("J-01", "lobby", "H", 110, 90, 70),
        JanelaPlanta("J-02", "lobby", "H", 240, 90, 60),
        JanelaPlanta("J-03", "recepcao", "H", 368, 90, 54),
        JanelaPlanta("J-04", "sala_eventos", "V", 80, 372, 56),
        JanelaPlanta("J-05", "administracao", "H", 336, 480, 54),
        JanelaPlanta("J-06", "deposito", "V", 860, 376, 46),
    )
    cameras = (
        CameraPlanta("CAM-01", "lobby", 340, 240, "NO"),
        CameraPlanta("CAM-02", "corredor_servico", 860, 285, "O"),
        CameraPlanta("CAM-03", "servico", 580, 330, "SE"),
        CameraPlanta("CAM-04", "sala_eventos", 300, 330, "SO"),
    )
    portoes = (
